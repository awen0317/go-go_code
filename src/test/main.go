...
func testMoifyString(str string, m rune) {
	s1 := []rune(str)
	s1[0] = m
	s := string(s1)
	fmt.Println(s)
...
func main() {
	...
	//testRWLock()
	//sortInt()
	//testMoifyString("main",'b')
	//var n int
	//fmt.Scanf("%d",&n)
	//a := strings.HasPrefix("abs","s")
	//a := strings.HasSuffix("abs","s")
	//a := strings.Index("abs","s")
	//a := strings.LastIndex("abs","s")
	//a := strings.Replace("abcab","a","d",1)
	//a :=strings.Count("abcab","c")
	//a :=strings.Repeat("abcab",2)
	//a :=strings.Fields("abcab c")
	//a :=strings.Split("ac1d","")
	//for _,val := range a{
	//	fmt.Println(val)
	//}
	//a :=time.Now()
	...
	//s := "12345"
	//index1 := len(s) - 1
	//fmt.Println(int(s[index1]))
	//fmt.Printf("%c", s[index1])
	//fmt.Printf("%T", (s[index1] - '0'))
	//
	//p := point{1, 2}
	//fmt.Printf("\n%v\n", p)
	//
